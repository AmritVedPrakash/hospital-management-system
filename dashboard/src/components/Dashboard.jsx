...
const Dashboard = () => {
  ...
  const handleUpdateStatus = async(appointmentId, status)=>{
    try {
      const {data} = await axios.put(`http://localhost:5000/api/v1/appointment/update/${appointmentId}`, 
      {status},
      {withCredentials: true}
     ) ;
    ...
    <div className='banner'>
      <div className='firstBox'>
        ...
        <div className='content'>
          ...
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellat voluptas, amet aliquid alias ea omnis nam. Minima sapiente rerum.</p>
